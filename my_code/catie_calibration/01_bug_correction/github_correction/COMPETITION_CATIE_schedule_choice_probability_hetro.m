...
%COMPETITION_CATIE_SCHEDULE_CHOICE_PROBABILITY_HETRO  Heterogeneous CATIE.
%   Mixture over the CAB-k sub-agents k = 0,1,2, weighted by each sub-agent's
%   posterior given the choices observed so far (Bayesian model averaging).
...
% Compute the average choice probabilities across all sub-agents, weighted by
% their likelihoods, separately for each trial.
